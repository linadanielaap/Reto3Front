function traerInformacionCategory (){
    $.ajax({
        url:"http://144.22.238.248/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategory(){
    ...
    if (nuevo.name == "" || nuevo.desCategory =="") {
        ...
        $.ajax({
            ...
            url:"http://144.22.238.248/api/Category/save",
            success:function(respuesta){
                console.log(respuesta);
...
function traerInformacionBarco (){
    $.ajax({
        url:"http://144.22.238.248/api/Boat/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionBarco(){
    ...
    if(nuevo.brand=="" || nuevo.year==""|| nuevo.description==""|| nuevo.nameBoat=="" ){
        ...
        $.ajax({
            ...
            datatype:"JSON",
            data: JSON.stringify(nuevo),
            url:"http://144.22.238.248/api/Boat/save",
            success:function(respuesta){
                console.log(respuesta);
...
function traerInformacion (){
    $.ajax({
        url:"http://144.22.238.248/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacion(){
    ...
    if (nuevo.nameClient=="" || nuevo.emailClient=="" || nuevo.passwordClient=="" || nuevo.age=="") {
        ...
        $.ajax({
            ...
            datatype:"JSON",
            data: JSON.stringify(nuevo),
            url:"http://144.22.238.248/api/Client/save",
            success:function(respuesta){
                console.log(respuesta);
...
function traerInformacionMensaje(){
    $.ajax({
        url:"http://144.22.238.248/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionMensaje(){
    ...
    if (nuevo.text=="") {
        ...
        $.ajax({
            ...
            datatype:"JSON",
            data: JSON.stringify(nuevo),
            url:"http://144.22.238.248/api/Message/save",
            success:function(respuesta){
                console.log(respuesta);
...
function traerInformacionAdmin(){
    $.ajax({
        url:"http://144.22.238.248/api/Admin/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionAdmin(){
    ...
    if (nuevo.nameAdmin=="" || nuevo.passwordAdmin=="" || nuevo.emailAdmin=="") {
        ...
        $.ajax({
            ...
            datatype:"JSON",
            data: JSON.stringify(nuevo),
            url:"http://144.22.238.248/api/Admin/save",
            success:function(respuesta){
                console.log(respuesta);
...
function traerInformacionReserva(){
    $.ajax({
        url:"http://144.22.238.248/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionReserva(){
    ...
    if (nuevo.startDate=="" || nuevo.endDate=="") {
        ...
        $.ajax({
            ...
            datatype:"JSON",
            data: JSON.stringify(nuevo),
            url:"http://144.22.238.248/api/Reservation/save",
            success:function(respuesta){
                console.log(respuesta);
